...
(function (e) {
  e.fn.smartZoom = function (t) {
    ...
    function u() {
      ...
      if (
        e.settings.mouseMoveEnabled != true ||
    ...
    function g(t) {
      ...
      if (r.transitionObject) {
        ...
        if (r.transitionObject.css3dSupported) {
          o[r.transitionObject.transform] =
            "translate3d(" +
            s.x +
            "px, " +
            s.y +
    ...
    function y(e, t, r, i) {
      ...
      o += Math.max(
        0,
        s.adjustedPosInfos.top + s.adjustedPosInfos.height - (o + i)
      );
      var u = Math.min(s.adjustedPosInfos.left, e);
      u += Math.max(
        0,
        s.adjustedPosInfos.left + s.adjustedPosInfos.width - (u + r)
      );
    ...
    function w() {
      ...
      var a = L(t);
      var f = Math.min(
        Math.min(a.width / r.width, a.height / r.height),
        1
      ).toFixed(2);
      var l = r.width * f;
      var c = r.height * f;
      ...
      E(
        n,
        e.adjustedPosInfos.left,
        e.adjustedPosInfos.top,
        l,
        c,
        0,
        function () {
    ...
    function E(t, r, i, s, o, u, a) {
      ...
      if (f.transitionObject != null) {
        ...
        if (f.transitionObject.css3dSupported)
          d[f.transitionObject.transform] =
            "translate3d(" +
            c +
            "px, " +
            h +
    ...
    var i = {
      init: function (t) {
        ...
        var u = e(
          '<div id="' + i + '" class="' + settings.containerClass + '"></div>'
        );
        n.before(u);
        n.remove();
        u = e("#" + i);
        ...
        if (settings.containerClass == "")
          u.css({ "background-color": settings.containerBackground });
        u.append(n);
        var l = new Object();
      ...
      destroy: function () {
        ...
        E(
          n,
          t.originalPosition.left,
          t.originalPosition.top,
